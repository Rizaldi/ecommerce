            ...
            <!-- <div class="shop-page-banner">
                ...
                <div class="tab-content">
                    <div id="grid" class="tab-pane show active fade" role="tabpanel">
                        <?php foreach ($product_category as $product_category_list): ?>
                        <?php $cat = $this->db->get_where('category', array('category_id'=>$product_category_list->category))->row(); ?>
                        <?php $sub_cat = $this->db->get_where('sub_category', array('sub_category_id'=>$product_category_list->sub_category))->row(); ?>

                        <?php if ($product_category_list->sub_category == null || $product_category_list->sub_category == '' || $product_category_list->sub_category == 0) {
                        	$sub_link = '';
                        }else{
                        	$sub_link = $sub_cat->sub_category_slug.'/';
                        } ?>
                        <div class="feature-item">
                            <div class="feature-img">
                                <a href="<?php echo site_url('product/'.$cat->category_slug.'/'.$sub_link.$product_category_list->title_slug) ?>"><img class="img_product" style="width: 271px; height: 250px;" src="<?php echo base_url('') ?>public/img/product/<?php echo $product_category_list->front_image; ?>" alt="feature"></a>
